function formatAntButtons(antTypes) {
    ...
    for (i = 0; i < antTypes.length; i++) {
        let name = antTypes[i].name;
        let foodCost = antTypes[i].food_cost;
        let nameSpan = document.createElement('span');
        nameSpan.innerHTML = name;
        nameSpan.classList.add('ant-name');
        let foodCostSpan = document.createElement('span');
        foodCostSpan.innerHTML = foodCost;
        foodCostSpan.classList.add('ant-food-cost');
        let antButton = document.createElement('button');
        antButton.appendChild(nameSpan);
        antButton.appendChild(foodCostSpan);
